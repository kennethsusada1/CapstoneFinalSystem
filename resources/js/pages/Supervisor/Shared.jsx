...
export function SupervisorStyles() {
    return (
        <style>{`
            ...
            @media (max-width: 1050px) { .sup-stats { grid-template-columns: repeat(2, 1fr); }.sup-grid-3 { grid-template-columns: 1fr 1fr; }.sup-grid-2 { grid-template-columns: 1fr; } }
            @media (max-width: 700px) { .sup-hero { align-items: flex-start; flex-direction: column; }.sup-hero-action { width: 100%; justify-content: center; }.sup-panel-head { align-items: flex-start; flex-direction: column; }.sup-search { width: 100%; min-width: 0; }.sup-grid-3, .sup-form-grid { grid-template-columns: 1fr; }.sup-field.full { grid-column: auto; } }
