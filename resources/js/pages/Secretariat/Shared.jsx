...
export function SecretariatStyles() {
    return (
        <style>{`
            ...
            @media (max-width: 700px) { .sec-hero { align-items: flex-start; flex-direction: column; padding: 1.15rem 1.1rem; }.sec-hero-action { width: 100%; }.sec-panel-head { align-items: flex-start; flex-direction: column; }.sec-search { width: 100%; min-width: 0; }.sec-grid-3, .sec-form { grid-template-columns: 1fr; }.sec-field.full { grid-column: auto; }.sec-panel { padding: .85rem; }.sec-button { width: 100%; } }
